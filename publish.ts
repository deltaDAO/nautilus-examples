import { AssetBuilder, ConsumerParameterBuilder, FileTypes, Nautilus, ServiceBuilder, ServiceTypes, UrlFile } from "@deltadao/nautilus"
import { NetworkConfig } from "config"
import { Wallet } from "ethers"



export async function publishAccessDataset(nautilus: Nautilus, networkConfig: NetworkConfig, pricingConfig: any, wallet: Wallet) {
...
export async function publishComputeDataset(nautilus: Nautilus, networkConfig: NetworkConfig, pricingConfig: any, wallet: Wallet) {
    const owner = await wallet.getAddress()
    console.log(`Your address is ${owner}`)
...
export async function publishComputeAlgorithm(nautilus: Nautilus, networkConfig: NetworkConfig, pricingConfig: any, wallet: Wallet) {
    const owner = await wallet.getAddress()
    console.log(`Your address is ${owner}`)
